...
@ccclass('RankPlayer5')
export class RankPlayer5 extends Component {
    ...
    private async loadList(rankType: string) {
        this._view.getChild('title').text = '人物养宠排行榜'
        let key = rankType;
    ...
    private renderListItem(index: number, button: fgui.GButton) {
        ...
        button.getChild("exp_medicine", fgui.GTextField).color = color().fromHEX('#FF0000');
    }
