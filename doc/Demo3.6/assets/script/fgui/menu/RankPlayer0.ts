...
@ccclass('RankPlayer0')
export class RankPlayer0 extends Component {
    ...
    private async loadList(rankType: string) {
        this._view.getChild('title').text = '人物红利排行榜'
        let key = rankType;
    ...
    private renderListItem(index: number, button: fgui.GButton) {
        ...
        button.getChild("additional_point", fgui.GTextField).color = color().fromHEX('#FF0000');
    }
