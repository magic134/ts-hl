...
@ccclass('RankPlayer6')
export class RankPlayer6 extends Component {
    ...
    private async loadList(rankType: string) {
        this._view.getChild('title').text = '人物创招排行榜'
        let key = rankType;
    ...
    private renderListItem(index: number, button: fgui.GButton) {
        ...
        button.getChild("exp_creative", fgui.GTextField).color = color().fromHEX('#FF0000');
    }
